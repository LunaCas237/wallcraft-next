...
// --- Updated CollectionSection with the Essential Layout Gap Logic ---
const CollectionSection = ({ 
  ...
  // Logic to separate the last word for highlighting, to match original Luxe styling

...
const HARDCODED_LIST: HardcodedProduct[] = [
  {
    title: 'Cement Design Board',
    itemCode: 'MBSNJZ',
    size: 'W1000 x H3000 x T4.5(+-0.5)mm',
    image:
      'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/urban_form_collection/Asset%2048.webp',
  },
  {
    title: 'Aggregate Wood',
    itemCode: 'MBQSW',
    size: 'W1000 x H2800 x T5(+-0.5)mm',
    image:
      'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/urban_form_collection/Asset%2047.webp',
  },
  {
    title: 'Fair Faced Concrete',
    itemCode: 'MBQSB',
    size: 'W1200 x H600 x T4mm\nW1200 x H3000 x T4mm',
    image:
      'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/urban_form_collection/Asset%2046.webp',
  },
];

export default function UrbanFormPage() {
  ...
  return (
    <div className="font-sans bg-[#0a0a0a] text-white min-h-screen">
      <header
        ...
        style={{
          backgroundImage:
            "linear-gradient(to right, rgba(10, 10, 10, 0.5) 0%, rgba(10, 10, 10, 0.2) 50%, rgba(10, 10, 10, 0) 100%), url('https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/collections_cover/Urban.webp')",
        ...
        <div className="container mx-auto px-8 lg:px-24 z-20">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl lg:text-8xl font-bold tracking-tight mb-6">
              <span className="text-[#B08038]">Urban Form</span>
              <br />
                    ...
                    {modalState.variants.map((variant) => {
                      ...
                      return (
                        <button
                          ...
                          type="button"
                          onClick={() => openProductModalById(variant.id)}
                          className={`w-14 h-14 border cursor-pointer hover:border-[#B08038] transition-all hover:scale-110 ${
                            isActive
                              ? 'border-[#B08038] scale-110'
                              : 'border-white/10'
                          }`}
                        >
                          <img

...
const HARDCODED_LIST: HardcodedProduct[] = [
  {
    ...
    size: '1200x2800x4mm',
    image:
      'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/nature_grain_collection/Asset%2053.webp',
  },
  {
    title: 'Bamboo Board(B)',
    itemCode: 'MBZWB',
    size: 'W600 x H2800(3.5-9)\nW1000 x H2800(3.5-9)mm',
    image:
      'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/nature_grain_collection/Asset%2052.webp',
  },
  {
    title: 'Bamboo Board(A)',
    itemCode: 'MBZWA',
    size: 'W600 x H2800(3.5-9)\nW980 x H2800(3.5-9)mm',
    image:
      'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/nature_grain_collection/Asset%2051.webp',
  },
  {
    title: 'Shou-Suji-Ban',
    itemCode: 'MBTHM',
    size: 'W600 x H2800 x T4mm',
    image:
      'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/nature_grain_collection/Asset%2050.webp',
  },
  {
    title: 'Carve Wood Board',
    itemCode: 'MBJMB',
    size: 'W600 x H3000 x T6(+-0.5)mm\nW1000 x H3000 x T6(+-0.5)mm',
    image:
      'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/nature_grain_collection/Asset%2049.webp',
  },
];
  ...
  return (
    <div className="font-sans bg-[#0a0a0a] text-white min-h-screen">
      <header
        ...
        style={{
          backgroundImage:
            "linear-gradient(to right, rgba(10, 10, 10, 0.5) 0%, rgba(10, 10, 10, 0.2) 50%, rgba(10, 10, 10, 0) 100%), url('https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/collections_cover/nature.webp')",
        ...
        <div className="container mx-auto px-8 lg:px-24 z-20">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl lg:text-8xl font-bold tracking-tight mb-6">
              <span className="text-[#B08038]">Nature Grain</span>
              <br />
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center space-y-4 py-20 opacity-60">
            ...
            <p className="text-[10px] uppercase tracking-[0.2em] text-zinc-500 font-medium">
              Synchronizing Nature Grain Textures...
            </p>
          </div>
        ) : (

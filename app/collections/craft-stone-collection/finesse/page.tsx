...
const HARDCODED_LIST: HardcodedProduct[] = [
  {
    ...
    itemCode: 'MBDSMSK',
    size: 'W1200 x H600mm\nW1200 x H3000mm',
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/finesse_collection/Asset%2071.webp',
  },
  {
    title: 'Ratten',
    itemCode: 'MBMB',
    size: 'W600 x H2400 x T5.5(+-0.5)mm\nW1000 x H2400 x T5.5(+-0.5)mm',
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/finesse_collection/Asset%2062.webp',
  },
  {
    title: 'Ripple Board',
    itemCode: 'MBBWB',
    size: 'W600 x H2800 x T(4-8)mm\nW1000 x H2800 x T(4-8)mm',
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/finesse_collection/Asset%2070.webp',
  },
  {
    title: 'Square Mosaic',
    itemCode: 'MBFMSk',
    size: 'W1180 x H2900 x T5mm',
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/finesse_collection/Asset%2069.webp',
  },
  {
    title: 'Big Slicing Pink Metallic',
    itemCode: 'BSPM-1',
    size: 'W1160 x H2360 x T6mm',
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/finesse_collection/Asset%2065.webp',
  },
  {
    title: 'Leaves Metallic Black',
    itemCode: 'LMB-1',
    size: 'W1160 x H2900 x T6mm',
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/finesse_collection/Asset%2066.webp',
  },
  {
    title: 'Ratten V',
    itemCode: 'RTV-1',
    size: 'W600 x H2400 x T5.5(+-0.5)mm\nW1000 x H2400 x T5.5(+-0.5)mm',
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/finesse_collection/Asset%2063.webp',
  },
  {
    title: 'Water Cube',
    itemCode: 'WC-1',
    size: 'W1160 x H3050 x T6 mm',
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/finesse_collection/Asset%2067.webp',
  },
  {
    title: 'Wood Cube',
    itemCode: 'WOODC-1',
    size: 'W1160 x H3050 x T6mm',
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/finesse_collection/Asset%2068.webp',
  },
  {
    title: 'Apple Leaf',
    itemCode: 'AL-1',
    size: 'W1160 x H3050 x T6mm',
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/finesse_collection/Asset%2064.webp',
  },
];
      ...
      <main className="max-w-[1600px] mx-auto px-8 lg:px-16 py-20 min-h-[50vh]">
        {loading ? (
          <div className="flex flex-col items-center justify-center space-y-4 py-20 opacity-60">
            ...
            <p className="text-[10px] uppercase tracking-[0.2em] text-zinc-500 font-medium">Synchronizing Finesse Surfaces...</p>
          </div>
        ) : (
          <div id="collection-grid">
            {HARDCODED_LIST.map((detail, i) => {
              const variants = groupedProducts[detail.title] || [];
              return (
                <section key={detail.title} className="mb-24 lg:mb-[12rem] text-left">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/95 backdrop-blur-md text-left" onClick={(e) => { if (e.target === e.currentTarget) closeModal(); }}>
          <div className="relative w-full max-w-6xl bg-[#0f0f0f] border border-white/10 rounded-xl overflow-hidden shadow-2xl flex flex-col lg:flex-row max-h-[95vh]">
            ...
            <div className="w-full lg:w-2/5 p-8 lg:p-12 flex flex-col border-l border-white/5 bg-[#0a0a0a] overflow-y-auto no-scrollbar">
              <div className="mb-8">
                <h3 className="text-[#B08038] text-[10px] font-bold tracking-[0.4em] uppercase mb-2">Finesse Signature</h3>
